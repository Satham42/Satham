...
<body>
    <header>
        <div class="header-content">
            ...
            <img src=" /storage/emulated/0/WhatsApp/Media/WhatsApp Images/IMG-20231025-WA0001.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>satham</h1>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>I' i am student of B.sc computer science e </p>
        </div>
    </section>
